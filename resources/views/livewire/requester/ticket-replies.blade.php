<div wire:init="loadReplies">
    ...
    <div wire:poll.visible.7s>
        ...
        <div wire:ignore.self class="modal slideIn animate ticket__actions__modal"
            id="replyTicketFilesModalForm{{ $reply->id }}" tabindex="-1" aria-labelledby="modalFormLabel"
            aria-hidden="true">

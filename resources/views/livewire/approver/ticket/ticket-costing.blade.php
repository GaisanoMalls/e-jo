...
<div>
    @if (!is_null($ticket->ticketCosting))
                                        ...
                                        @if ($costingApprover->profile->picture)
                                            <div class="d-flex position-relative">
                                                <img class="costing__approver__picture rounded-circle"
                                                    ...
                                                    data-tooltip="{{ $costingApprover->profile->getFullName }}" data-tooltip-position="top"
                                ...
                                @else
                                    <div class="d-flex align-items-center gap-2">
                                        <button wire:click="approveCostingApproval2"
                                            ...
                                            <i class="bi bi-check2-circle" wire:loading.class="d-none" wire:target="approveCostingApproval2"></i>
        ...
        <div wire:ignore.self class="modal fade clarification__modal" id="costingReasonOfDisapprovalModal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal__body">
                        <form wire:submit.prevent="disapproveCostingApproval2">
                            ...
                            <button type="submit" class="btn mt-4 d-flex align-items-center justify-content-center gap-2 btn__send__ticket__reply">
                                <span wire:loading wire:target="disapproveCostingApproval2" class="spinner-border spinner-border-sm" role="status"
                                    aria-hidden="true">
                                </span>
                                Send
                            </button>

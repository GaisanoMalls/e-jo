            ...
            <div class="modal-content modal__content">
                <form wire:submit.prevent="disapproveTicket">
                    <div class="modal-body border-0 px-4 pt-4 pb-1 mb-3">
                        ...
                        <div wire:ignore>
                            <textarea wire:model="disapproveReason" id="disapprove-reason"></textarea>
                        </div>
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                ...
                editor.on('change', function() {
                    @this.set('disapproveReason', editor.getContent());
                });
            }
        });
    </script>
...
@push('livewire-modal')
    <script>
        ...
        window.addEventListener('reload-modal', () => {
            tinymce.get("disapproveReason").setContent("");
        });
    </script>
@endpush

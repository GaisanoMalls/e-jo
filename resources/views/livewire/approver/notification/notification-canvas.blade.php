<div>
    <div wire:ignore.self class="offcanvas offcanvas-end rounded-3 shadow border-0 notification__canvas" tabindex="-1"
        ...
        @if (auth()->user()->notifications->isNotEmpty())
            ...
            <div class="offcanvas-body py-0 px-0">
                @livewire('approver.notification.notification-list')
            </div>
        @else

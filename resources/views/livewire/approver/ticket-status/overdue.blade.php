    ...
    <div class="row">
        <div class="mb-4 d-flex flex-wrap justify-content-between">
            <div class="d-flex align-items-center gap-4">
                <h5 class="page__header__title">Overdue Tickets</h5>
                <small class="fw-semibold mb-1" id="countSelectedChbx" style="color: #d32839;"></small>
            </div>
            <div class="d-flex align-items-center justify-content-center">
                <small class="count-item">{{ $overdueTickets->count() }} items</small>
            </div>
        </div>
    </div>
    <div class="row mx-0">
        ...
        @else
            <div class="py-3 px-4 rounded-3" style="background-color: #e9ecef;">
                <small style="font-size: 14px;">No overdue tickets.</small>
            </div>
        @endif
    </div>
</div>

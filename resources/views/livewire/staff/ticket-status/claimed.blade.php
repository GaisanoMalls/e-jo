            ...
            <div class="d-flex flex-wrap gap-3 align-items-center justify-content-lg-between">
                <div class="d-flex flex-column flex-wrap gap-1 position-relative">
                    <div class="w-100 d-flex align-items-center position-relative">
                        <input wire:model.debounce.400ms="searchTicket" type="text" class="form-control table__search__field" placeholder="Search ticket" @disabled($this->isEmptyClaimedTickets())>
                    ...
                    @if (!empty($searchTicket))
                        <div class="w-100 d-flex align-items-center gap-2 mb-1 position-absolute" style="font-size: 0.9rem; bottom: -25px;">
                            <small class="text-muted ">
                                {{ $claimedTickets->count() }} {{ $claimedTickets->count() > 1 ? 'results' : 'result' }} found
                            </small>
                ...
                <div class="d-flex gap-3 align-items-center w-auto">
                    <div class="position-relative">
                        ...
                        <input type="date" wire:model="startDate" class="form-control form__field" id="start-date" @disabled($this->isEmptyClaimedTickets())>
                    </div>
                    <div class="position-relative">
                        <label for="end-date" class="form-label position-absolute form__field__label" style="top: -25px;">To</label>
                        <input type="date" wire:model="endDate" class="form-control form__field" id="end-date" @disabled($this->isEmptyClaimedTickets())>
                    </div>
                </div>
                <div class="d-flex">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm d-flex align-items-center gap-2 rounded-2 sort__button" data-bs-toggle="dropdown" aria-expanded="false" @disabled($this->isEmptyClaimedTickets())>

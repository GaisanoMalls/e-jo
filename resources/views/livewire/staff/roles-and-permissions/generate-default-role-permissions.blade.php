<div>
    <div>
        <button wire:click="generateDirectPermissions" wire:loading.attr="disabled" type="button"
            ...
            <span wire:loading wire:target="generateDirectPermissions" class="spinner-border spinner-border-sm"

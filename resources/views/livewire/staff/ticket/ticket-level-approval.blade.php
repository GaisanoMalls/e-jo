...
<div>
    <div class="card border-0 p-0 card__ticket__details">
        <div class="d-flex flex-column gap-3 ticket__details__card__body__right">
            @if ($nonConfigApproval !== null && !empty($nonConfigApprovers))
                <label class="ticket__actions__label">Ticket Approval</label>
                <div class="d-flex flex-column level__approval__container">
                    <div class="d-flex align-items-center justify-content-between gap-1 mb-2">
                        <small class="level__number__label">
                            Approvers
                        </small>
                        @if ($nonConfigApprovalIsApproved)
                    ...
                    @foreach ($nonConfigApprovers as $approver)

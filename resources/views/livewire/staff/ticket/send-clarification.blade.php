<div>
    <div wire:ignore.self class="modal fade modal-xl ticket__actions__modal" id="sendTicketClarificationModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered custom__modal">
            <div class="modal-content d-flex flex-column custom__modal__content">
                ...
                @livewire('staff.ticket.latest-clarification', ['ticket' => $ticket])
                <div class="modal__body">
                    <form wire:submit.prevent="sendClarification">
                        ...
                        <div class="mt-4">
                            ...
                            <input class="form-control ticket__file__input w-auto my-3" type="file" wire:model="clarificationFiles" multiple
                                id="upload-{{ $upload }}">
                        ...
                        <button type="submit" class="btn mt-3 d-flex align-items-center justify-content-center gap-2"
                            ...
                            <span wire:loading wire:target="sendClarification" class="spinner-border spinner-border-sm" role="status"
                                aria-hidden="true">
                            </span>
                            <span wire:loading.remove wire:target="sendClarification">
                                Send
                            </span>
                            <span wire:loading wire:target="sendClarification">
                                Sending
                            </span>
                        </button>
                    </form>
...
@push('livewire-modal')
    <script>
        window.addEventListener('close-modal', () => {
            $('#sendTicketClarificationModal').modal('hide');
        });

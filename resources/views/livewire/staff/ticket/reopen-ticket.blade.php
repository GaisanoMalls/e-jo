<div>
    ...
    <div wire:ignore.self class="modal fade modal__confirm__close__ticket" id="confirmReopenTicketModal" tabindex="-1" aria-hidden="true">
                ...
                <form wire:submit.prevent="reopenTicket">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-3 pb-4 px-4">
                        ...
                        <button type="submit"
                            ...
                            <span wire:loading wire:target="reopenTicket" class="spinner-border spinner-border-sm" role="status" aria-hidden="true">
                            </span>
                            Yes, reopen this ticket
                        </button>
                    </div>
                </form>
            </div>

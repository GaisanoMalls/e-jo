<div wire:ignore.self class="modal fade edit__password__modal" id="editPasswordModal"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            ...
            <form wire:submit.prevent="updatePassword({{ $approver->id }})">
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button type="submit"
                            ...
                            <span wire:loading wire:target="updatePassword({{ $approver->id }})"

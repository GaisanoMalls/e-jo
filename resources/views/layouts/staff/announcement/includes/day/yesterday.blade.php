<div class="row">
    <div class="row">
        ...
        <div class="col-xxl-11 col-lg-10 col-md-10 col-9">
            <h6 style="margin-bottom: 30px; color: #858585;">Yesterday</h6>
        </div>
    </div>
    @foreach ($yesterday_announcements as $announcement)
                    ...
                    <div class="announcement__content">
                        <div class="d-flex align-items-center justify-content-between flex-nowrap">
                            ...
                            <div class="btn-group dropstart">
                                <button type="button"
                                    class="btn d-flex align-items-center justify-content-center btn__menu"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-ellipsis"></i>
                                </button>
                                <ul class="dropdown-menu border-0 custom__dropdown__menu">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center custom__dropdown__item"
                                            href="#">

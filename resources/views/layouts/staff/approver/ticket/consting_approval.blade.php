@extends('layouts.staff.approver.base', ['title' => 'Costing Approvals'])
        ...
        <div class="row">
            <div class="mb-4 d-flex flex-wrap justify-content-between">
                <div class="d-flex align-items-center gap-4">
                    <h5 class="page__header__title">Costing Approvals</h5>
                    <small class="fw-semibold mb-1" id="countSelectedChbx" style="color: #d32839;"></small>
                </div>
                <div class="d-flex align-items-center justify-content-center">
                    <small class="count-item">15 items</small>
                </div>
            </div>
        </div>
        <div class="row mx-0">
            @if ($ticketsWithCostings->isNotEmpty())
            ...
            @else
                <div class="py-3 px-4 rounded-3" style="background-color: #e9ecef;">
                    <small style="font-size: 14px;">No costing tickets.</small>
                </div>
            @endif
        </div>
    </div>

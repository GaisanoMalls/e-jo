    ...
    <div class="container gap-3">
        ...
        <div class="d-flex align-items-center" style="gap: 1.9rem;">
            <li class="nav-item my-auto list-unstyled dropdown d-block d-lg-none">
                <a wire:click="approverShowNotifications" class="nav-link icon__nav__link position-relative"
                    type="button" data-bs-toggle="offcanvas" data-bs-target="#notificationCanvas">
            ...
            <li class="nav-item my-auto dropdown list-unstyled d-block d-lg-none">
                <a class="nav-link mx-1" role="button" data-bs-toggle="dropdown" aria-expanded="false">

<div class="card w-100 border-0 p-0 card__directory directory__tab__container">
    <ul
        ...
        <li>
            <a href="{{ route('staff.directory.approvers') }}" class="btn d-flex align-items-center border-0 directory__tab__button
        ...
        <li>
            <a href="{{ route('staff.directory.agents') }}" class="btn d-flex align-items-center border-0 directory__tab__button

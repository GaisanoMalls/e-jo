@extends('layouts.staff.base', ['title' => 'Tickets - Approval Level'])
        ...
        <div class="ticket__section">
            <div class="col-12">
                <div class="card d-flex flex-column tickets__card p-0">
                    <div class="tickets__card__header pb-0 pt-4 px-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex flex-column me-3">
                                <h6 class="card__title">Level Approval</h6>
                                {{-- <p class="card__description">
                                    These tickets has no team and agent assigned.
                                </p> --}}
                            </div>
                            <div class="d-flex">
                                <button type="button"
                    ...
                    @livewire('staff.ticket-level-approvals')
                </div>
            </div>
        </div>
    </div>

@extends('layouts.staff.base', ['title' => 'View Ticket'])
        ...
        <div class="col-xl-12 ticket__details__container">
            ...
            <div class="row">
                <div class="col-md-8 position-relative">
                    ...
                    <div class="mb-2">
                        <small class="ticket__discussions">{{ $ticket->replies->count() }} Discussions</small>
                    </div>
                    {{-- Replies/Comments --}}
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center w-100">
                                <img src="https://samuelsabellano.pythonanywhere.com/media/profile/1_Sabellano_Samuel_Jr_C__DSC9469.JPG"
                                    alt="" class="image-fluid ticket__details__user__picture

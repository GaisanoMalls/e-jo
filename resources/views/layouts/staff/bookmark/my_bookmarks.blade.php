@extends('layouts.staff.base', ['title' => 'Bookmarked Tickets'])

@section('page-header')
    <div class="justify-content-between d-flex flex-wrap ticket__content__top">
        <div class="col-lg-7 col-md-5">
            <h3 class="page__header__title">Bookmarks</h3>
            <ol class="breadcrumb">
                ...
                <div class="card d-flex flex-column tickets__card p-0">
                    <div class="tickets__card__header pb-0 pt-4 px-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex flex-column me-3">
                                <h6 class="card__title">My Bookmarks</h6>
                                <p class="card__description">
                                    A way to mark your tickets so you can easily find them later.
                                </p>
                            </div>
                            <div class="d-flex">
                                <button type="button"
                    ...
                    <div class="tickets__table__card">
                        <div class="table-responsive custom__table">
                            @if ($bookmarkedTickets->isNotEmpty())
                                <table class="table table-striped mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($bookmarkedTickets as $ticket)
                                            <tr class="ticket__tr"
                                                ...
                                                <td class="position-relative">
                                                    ...
                                                    <div class="d-flex align-items-center text-start td__content">
                                                        <i class="fa-solid fa-bookmark" style="color: #196837;"></i>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center text-start td__content">

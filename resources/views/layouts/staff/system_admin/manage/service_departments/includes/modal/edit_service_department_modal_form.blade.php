<div class="modal department__modal" id="editServiceDepartment{{ $serviceDepartment->id }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            ...
            <form action="{{ route('staff.manage.service_department.update', $serviceDepartment->id) }}" method="post"
                    ...
                    <div class="row mb-2">
                        <div class="mb-2">
                            ...
                            <input type="text" name="name" class="form-control form__field" id="name"
                                value="{{ $serviceDepartment->name ?? old('name') }}" placeholder="Type here...">

<div class="modal department__modal" id="addNewBranchModal" tabindex="-1" aria-labelledby="addNewBranchModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            ...
            <form action="{{ route('staff.manage.branch.store') }}" method="post" autocomplete="off" id="modalForm">
                @csrf

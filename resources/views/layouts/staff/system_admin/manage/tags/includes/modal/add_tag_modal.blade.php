<div class="modal tag__modal" id="addNewTagModal" tabindex="-1" aria-labelledby="addNewTagModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            ...
            <form action="{{ route('staff.manage.tags.store') }}" method="post" autocomplete="off" id="modalForm">
                @csrf

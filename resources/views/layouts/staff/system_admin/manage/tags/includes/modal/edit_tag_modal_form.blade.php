<div class="modal tag__modal" id="editTag{{ $tag->id }}" tabindex="-1" aria-labelledby="addNewTagModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            ...
            <form action="{{ route('staff.manage.tag.update', $tag->id) }}" method="post" autocomplete="off"
                id="modalForm">
                @csrf
                @method('PUT')

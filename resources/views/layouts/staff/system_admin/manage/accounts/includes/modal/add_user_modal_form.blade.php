<div class="modal fade account__modal" id="addNewUserModal" tabindex="-1" aria-labelledby="addNewUserModalLabel"
    aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <select name="department" data-search="true" placeholder="Select (required)"

<div class="modal fade account__modal" id="addNewServiceDeptAdminModal" tabindex="-1"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            <label for="role" class="form-label form__field__label">User
                                                role</label>
                                            <input type="text" value="Department Admin" class="form-control form__field"
                                                disabled readonly
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            <label for="department" class="form-label form__field__label">
                                                BU/Department
                                                <span id="deptAdminCountBUDepartments" style="font-size: 13px;"></span>
                                                <br>
                                                <span id="deptAdminNoBUDepartmentsMessage" class="text-danger fw-normal"

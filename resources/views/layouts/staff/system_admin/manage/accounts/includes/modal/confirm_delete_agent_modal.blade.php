<div class="modal slideIn animate modal__confirm__delete__user__account" id="confirmDeleteAgent{{ $agent->id }}"
    tabindex="-1" aria-labelledby="confirmDeleteAgentLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            <form action="{{ route('staff.manage.user_account.agent.delete', $agent->id) }}" method="post">
                @csrf
                @method('DELETE')

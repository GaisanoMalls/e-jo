<div class="modal fade modal__confirm__delete__user__account" id="confirmDeleteAgent{{ $agent->id }}" tabindex="-1"
    aria-labelledby="confirmDeleteAgentLabel" aria-hidden="true">

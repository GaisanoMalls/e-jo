<div class="modal slideIn animate modal__confirm__delete__user__account" id="confirmDeleteUser{{ $user->id }}"
    tabindex="-1" aria-labelledby="confirmDeleteUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal__content">
            <form action="{{ route('staff.manage.user_account.user.delete', $user->id) }}" method="post">
                @csrf
                @method('DELETE')

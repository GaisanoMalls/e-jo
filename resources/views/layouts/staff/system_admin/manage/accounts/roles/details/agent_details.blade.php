@extends('layouts.staff.system_admin.manage.manage_main', ['title' => 'Details - ' . $agent->profile->getFullName])
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="rounded-3 d-flex flex-wrap align-items-center gap-2"
                                        ...
                                        @if ($agent->getDirectPermissions()->isNotEmpty())
                                            @foreach ($agent->getDirectPermissions() as $permission)

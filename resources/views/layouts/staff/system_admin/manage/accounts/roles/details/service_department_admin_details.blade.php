@extends('layouts.staff.system_admin.manage.manage_main', ['title' => 'Details - ' . $serviceDeptAdmin->profile->getFullName()])
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="first_name" class="form-control form__field" id="first_name"
                                        value="{{ $serviceDeptAdmin->profile->first_name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="middle_name" class="form-control form__field"
                                        id="middle_name" value="{{ $serviceDeptAdmin->profile->middle_name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="last_name" class="form-control form__field" id="last_name"
                                        value="{{ $serviceDeptAdmin->profile->last_name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form__field" id="email"
                                        value="{{ $serviceDeptAdmin->profile->suffix }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form__field" id="email"
                                        value="{{ $serviceDeptAdmin->email }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form__field" id="email"
                                        value="{{ $serviceDeptAdmin->getBranches() }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form__field" id="email"
                                        value="{{ $serviceDeptAdmin->getBUDepartments() }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form__field" id="email"
                                        value="{{ $serviceDeptAdmin->getServiceDepartments() }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="rounded-3 d-flex flex-wrap align-items-center gap-2"
                                            ...
                                            @if ($serviceDeptAdmin->getDirectPermissions()->isNotEmpty())
                                                @foreach ($serviceDeptAdmin->getDirectPermissions() as $permission)

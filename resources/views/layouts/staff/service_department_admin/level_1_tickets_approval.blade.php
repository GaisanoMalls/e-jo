@extends('layouts.staff.base', ['title' => 'Level 1 - Approve Ticketa'])

@section('page-header')
<div class="justify-content-between d-flex flex-wrap mb-3 ticket__content__top">
    <div class="col-lg-7 col-md-5">
        <h3 class="page__header__title">Level 1 Approval</h3>
    </div>
</div>
@endsection
            ...
            <div class="card d-flex flex-column tickets__card p-0">
                <div class="tickets__card__header pb-0 pt-4 px-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column me-3">
                            <h6 class="card__title">Level 1 approvals for these tickets.</h6>
                            <p class="card__description">
                                Once you approved these tickets, the level 2 approver will take over the next approval.
                            </p>
                        </div>
                        <div class="d-flex">
                            <button type="button"
                ...
                <div class="tickets__table__card">
                    <div class="table-responsive custom__table">
                        @if (!$level1ApprovalTickets->isEmpty())
                        <table class="table table-striped mb-0" id="table">
                            ...
                            <tbody>
                                @foreach ($level1ApprovalTickets as $ticket)
                                <tr class="ticket__tr"
                                    onclick="window.location='{{ route('staff.service_dept_head.level_1_approval.show', $ticket->id) }}'">

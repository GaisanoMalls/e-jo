...
<div class="modal slideIn animate ticket__actions__modal" id="requesterTicketFilesModalForm" tabindex="-1"
        ...
        <div class="modal-content custom__modal__content">
            <div class="modal__header d-flex justify-content-between align-items-center">
                <h6 class="modal__title">
                    {{ $ticket->fileAttachments->count() > 1 ? 'Reply file attachments' : 'Reply file attachment'}}
                    ...
                    <li class="list-group-item d-flex align-items-center px-0 py-3 justify-content-between">
                        <a href="{{ Storage::url($ticket->file_attachment) }}" class="file__preview__link"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                @default
                                @endswitch
                                <p class="mb-0" style="font-size: 14px;">{{ basename($ticket->file_attachment) }}</p>
                            </div>
                        </a>

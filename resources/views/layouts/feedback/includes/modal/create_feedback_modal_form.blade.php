<form action="{{ route('feedback.store') }}" method="post">
    @csrf
    <div class="modal feedback__modal" id="ticketFeedbackModal{{ $ticket->id }}" tabindex="-1"
                        ...
                        <div class="row form__inputs">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form__field" name="fullname" id="fullname"
                                        readonly value="{{ auth()->user()->profile->getFullName() }}"

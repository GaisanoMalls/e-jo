...
class Claimed extends Component
{
    ...
    public Collection|LengthAwarePaginator $claimedTickets;
    ...
    {
        return $this->claimedTickets->isEmpty()
            && (
                !$this->searchTicket
    ...
    {
        $filteredTickets = $this->getClaimedTickets()->filter(function ($ticket) {
        ...
        $this->claimedTickets = collect($paginatedTickets->items());

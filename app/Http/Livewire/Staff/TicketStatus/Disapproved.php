...
class Disapproved extends Component
{
    ...
    public Collection|LengthAwarePaginator $disapprovedTickets;
    ...
    {
        return $this->disapprovedTickets->isEmpty()
            && (
                !$this->searchTicket
    ...
    {
        $filteredTickets = $this->getDisapprovedTickets()->filter(function ($ticket) {
        ...
        $this->disapprovedTickets = collect($paginatedTickets->items());

        return view('livewire.staff.ticket-status.disapproved', [
            'disapprovedTickets' => $this->disapprovedTickets,
